...
const MENU = {
  beer: {
    label: "🍺 ლუდის მენიუ",
    items: [
      { id: "b1", name: "ბიტბურგერი", desc: "ჩამოსასხმელი", price: 9.20, price2: 18.80, unit1: "0.4 ლ", unit2: "1 ლ", img: "/images/bitburger.jpg" },
      ...
      { id: "b3", name: "ბენედიქტინერ გაუფ.", desc: "ჩამოსასხმელი", price: 10.50, price2: 21.00, unit1: "0.4 ლ", unit2: "1 ლ", img: "/images/benediktiner-unfiltered.jpg" },
      { id: "b4", name: "კილსნერ ურქველი", desc: "ჩამოსასხმელი", price: 9.70, price2: 19.40, unit1: "0.4 ლ", unit2: "1 ლ", img: "/images/kilkenny.jpg" },
